...
class equalizerNode extends CompositeAudioNode {
  _wamNode;
...
export default class equalizerPlugin extends WebAudioModule {
  _PluginFactory;
  ...
  async createAudioNode(initialState) {
    ...
    const node = new equalizerNode(this.audioContext);
