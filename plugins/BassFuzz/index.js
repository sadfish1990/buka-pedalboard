...
import BassFuzzNode from "./Node.js";
...
export default class BassFuzzPlugin extends WebAudioModule {
    ...
    async createAudioNode(initialState) {
        const node = new BassFuzzNode(this.audioContext, { baseURL: this._baseURL });

        const paramMgr = await ParamMgrFactory.create(this, {
            internalParamsConfig: {
                vol: { defaultValue: 0.5, minValue: 0, maxValue: 1 },
                tone: { defaultValue: 0.5, minValue: 0, maxValue: 1 },
                sustain: { defaultValue: 0.5, minValue: 0, maxValue: 1 },
