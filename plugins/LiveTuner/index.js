...
import LiveTunerNode from "./Node.js";
...
export default class LiveTunerPlugin extends WebAudioModule {
    ...
    async createAudioNode(initialState) {
        const node = new LiveTunerNode(this.audioContext, { baseURL: this._baseURL });

        const paramMgr = await ParamMgrFactory.create(this, {
            internalParamsConfig: {
                bypass: { defaultValue: 0, minValue: 0, maxValue: 1 } // 0=Sound, 1=Mute(Tuning)
            }
        });
