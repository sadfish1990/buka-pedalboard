...
<img id="background-image">
	...
	<div class="label" id="label_713">Clean Machine</div>
`;

let backgroundImg = "../assets/CleanMachine.png";
...
export default class CleanMachineHTMLElement extends HTMLElement {
	...
	static is() {
		return "wasabi-cleanmachine";
	}
}

if (!customElements.get(CleanMachineHTMLElement.is())) {
	customElements.define(CleanMachineHTMLElement.is(), CleanMachineHTMLElement);
}
