...
import NoiseKillerNode from "./Node.js";
...
export default class NoiseKillerPlugin extends WebAudioModule {
    ...
    async createAudioNode(initialState) {
        const node = new NoiseKillerNode(this.audioContext, { baseURL: this._baseURL });

        const paramMgr = await ParamMgrFactory.create(this, {
            internalParamsConfig: {
                threshold: { defaultValue: 0.5, minValue: 0, maxValue: 1 }
            }
        });
