import '../utils/webaudio-controls.js'
      ...
      // check if the shadowroot host has a background image
        ...
        this._root.getElementById('/Kpp_fuzz/volume').value = this._plug.audioNode.getParamValue('/Kpp_fuzz/volume');
          ...
          this._root.getElementById('/Kpp_fuzz/99_bypass').value = 1 - this._plug.audioNode.getParamValue('/Kpp_fuzz/99_bypass');
...
window.requestAnimationFrame(this.handleAnimationFrame);
        ...
        return ['state'];
              ...
              setKnobs() {
                 this._root.getElementById("/Kpp_fuzz/fuzz").addEventListener("input", (e) =>this._plug.audioNode.setParamValue("/Kpp_fuzz/fuzz", e.target.value));
this._root.getElementById("/Kpp_fuzz/tone").addEventListener("input", (e) =>this._plug.audioNode.setParamValue("/Kpp_fuzz/tone", e.target.value));
this._root.getElementById("/Kpp_fuzz/volume").addEventListener("input", (e) =>this._plug.audioNode.setParamValue("/Kpp_fuzz/volume", e.target.value));
              ...
              setSwitches() {
                 this._root.getElementById("/Kpp_fuzz/99_bypass").addEventListener("change", (e) =>this._plug.audioNode.setParamValue("/Kpp_fuzz/99_bypass", 1 - e.target.value));
      ...
      try {
          customElements.define('wap-kpp_fuzz', 
                                Kpp_fuzzGui);
