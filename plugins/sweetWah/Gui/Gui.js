...
window.requestAnimationFrame(this.handleAnimationFrame);
        ...
        return ['state'];
              ...
              setKnobs() {
                 this._root.getElementById("/Sweet/Frequency").addEventListener("input", (e) =>this._plug.audioNode.setParamValue("/Sweet/Frequency", e.target.value));
this._root.getElementById("/Sweet/High").addEventListener("input", (e) =>this._plug.audioNode.setParamValue("/Sweet/High", e.target.value));
this._root.getElementById("/Sweet/Low").addEventListener("input", (e) =>this._plug.audioNode.setParamValue("/Sweet/Low", e.target.value));
this._root.getElementById("/Sweet/Mix").addEventListener("input", (e) =>this._plug.audioNode.setParamValue("/Sweet/Mix", e.target.value));
              ...
              setSwitches() {
                 this._root.getElementById("/Sweet/bypass").addEventListener("change", (e) =>this._plug.audioNode.setParamValue("/Sweet/bypass", 1 - e.target.value));
      ...
      try {
          customElements.define('wap-sweet', 
                                SweetGui);
