...
export default class kbverbGui extends HTMLElement {
  ...
  setKnobs() {
    this._root
      .getElementById("/kbverb/damp")
      .addEventListener("input", (e) => this._plug.audioNode.setParamValue("/kbverb/damp", e.target.value));
    this._root
      .getElementById("/kbverb/earlyDiff")
      .addEventListener("input", (e) => this._plug.audioNode.setParamValue("/kbverb/earlyDiff", e.target.value));
    this._root
      .getElementById("/kbverb/highBand")
      .addEventListener("input", (e) => this._plug.audioNode.setParamValue("/kbverb/highBand", e.target.value));
    this._root
      .getElementById("/kbverb/highX")
      .addEventListener("input", (e) => this._plug.audioNode.setParamValue("/kbverb/highX", e.target.value));
    this._root
      .getElementById("/kbverb/lowBand")
      .addEventListener("input", (e) => this._plug.audioNode.setParamValue("/kbverb/lowBand", e.target.value));
    this._root
      .getElementById("/kbverb/lowX")
      .addEventListener("input", (e) => this._plug.audioNode.setParamValue("/kbverb/lowX", e.target.value));
    this._root
      .getElementById("/kbverb/mDepth")
      .addEventListener("input", (e) => this._plug.audioNode.setParamValue("/kbverb/mDepth", e.target.value));
    this._root
      .getElementById("/kbverb/mFreq")
      .addEventListener("input", (e) => this._plug.audioNode.setParamValue("/kbverb/mFreq", e.target.value));
    this._root
      .getElementById("/kbverb/midX")
      .addEventListener("input", (e) => this._plug.audioNode.setParamValue("/kbverb/midX", e.target.value));
    this._root
      .getElementById("/kbverb/size")
      .addEventListener("input", (e) => this._plug.audioNode.setParamValue("/kbverb/size", e.target.value));
    this._root
      .getElementById("/kbverb/t60")
      .addEventListener("input", (e) => this._plug.audioNode.setParamValue("/kbverb/t60", e.target.value));
  }
  ...
  setSwitches() {
    this._root
      ...
      .addEventListener("change", (e) => this._plug.audioNode.setParamValue("/kbverb/bypass", 1 - e.target.value));
  }
...
try {
  customElements.define("wap-jpverb", kbverbGui);
