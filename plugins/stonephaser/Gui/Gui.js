...
<div class="webaudio-knob-body" tabindex="1" touch-action="none" style="background-image: url(&quot;./img/knobs/knob2.png&quot;); outline: none; width: 60px; height: 60px; background-position: 0px -1020px; background-size: 60px 6060px; transform: rotate(0deg);"></div><div class="webaudioctrl-tooltip" style="display: inline-block; width: auto; height: auto; transition: opacity 0.1s ease 0s, visibility 0.1s ease 0s; opacity: 0; visibility: hidden; left: 1012.88px; top: -36.5px;">17</div>
      ...
      // check if the shadowroot host has a background image
        ...
        this._root.getElementById('/untitled/LFO frequency').value = this._plug.audioNode.getParamValue('/untitled/LFO frequency');
        

        this._root.getElementById('/untitled/Feedback depth').value = this._plug.audioNode.getParamValue('/untitled/Feedback depth');
        

        this._root.getElementById('/untitled/Feedback bass cut').value = this._plug.audioNode.getParamValue('/untitled/Feedback bass cut');
        

        this._root.getElementById('/untitled/Dry/wet mix').value = this._plug.audioNode.getParamValue('/untitled/Dry/wet mix');
...
window.requestAnimationFrame(this.handleAnimationFrame);
        ...
        return ['state'];
              ...
              setKnobs() {
                 this._root.getElementById("/untitled/Color").addEventListener("input", (e) =>this._plug.audioNode.setParamValue("/untitled/Color", e.target.value));
this._root.getElementById("/untitled/LFO frequency").addEventListener("input", (e) =>this._plug.audioNode.setParamValue("/untitled/LFO frequency", e.target.value));
this._root.getElementById("/untitled/Feedback depth").addEventListener("input", (e) =>this._plug.audioNode.setParamValue("/untitled/Feedback depth", e.target.value));
this._root.getElementById("/untitled/Feedback bass cut").addEventListener("input", (e) =>this._plug.audioNode.setParamValue("/untitled/Feedback bass cut", e.target.value));
this._root.getElementById("/untitled/Dry/wet mix").addEventListener("input", (e) =>this._plug.audioNode.setParamValue("/untitled/Dry/wet mix", e.target.value));
      ...
      try {
          customElements.define('wap-untitled', 
                                untitledGui);
