...
let backgroundImg = "../assets/MetalMachine.png";
...
export default class MetalMachineHTMLElement extends HTMLElement {
	...
	static is() {
		return "wasabi-metalmachine";
	}
}

if (!customElements.get(MetalMachineHTMLElement.is())) {
	customElements.define(MetalMachineHTMLElement.is(), MetalMachineHTMLElement);
}
