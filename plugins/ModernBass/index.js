...
import ModernBassNode from "./Node.js";
...
export default class ModernBassPlugin extends WebAudioModule {
    ...
    async createAudioNode(initialState) {
        const node = new ModernBassNode(this.audioContext, { baseURL: this._baseURL });

        const paramMgr = await ParamMgrFactory.create(this, {
            internalParamsConfig: {
                contour: { defaultValue: 0.0, minValue: 0, maxValue: 1 },
                drive: { defaultValue: 0.2, minValue: 0, maxValue: 1 },
                blend: { defaultValue: 0.0, minValue: 0, maxValue: 1 },
                bass: { defaultValue: 0.5, minValue: 0, maxValue: 1 },
                lomid: { defaultValue: 0.5, minValue: 0, maxValue: 1 },
                himid: { defaultValue: 0.5, minValue: 0, maxValue: 1 },
