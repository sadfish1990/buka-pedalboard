...
import OrangeDistortionNode from "./Node.js";
...
export default class OrangeDistortionPlugin extends WebAudioModule {
    ...
    async createAudioNode(initialState) {
        const node = new OrangeDistortionNode(this.audioContext, { baseURL: this._baseURL });
