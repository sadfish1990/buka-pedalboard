...
class distorderNode extends CompositeAudioNode {
  _wamNode;
...
export default class distorderPlugin extends WebAudioModule {
  _PluginFactory;
  ...
  async createAudioNode(initialState) {
    ...
    const node = new distorderNode(this.audioContext);
