...
process = output with {
    ...
    drive = vslider("drive[style:knobs]",63,0,100,0.01);
    volume = vslider("volume[style:knobs]",0.5,0,1,0.001);
    voice = vslider("voice[style:knobs]",0.5,0,1,0.001);

    tonestack_low = vslider("bass[style:knobs]",0,-15,15,0.1);
    tonestack_middle = vslider("middle[style:knobs]",0,-15,15,0.1);
    tonestack_high = vslider("treble[style:knobs]",0,-15,15,0.1);
