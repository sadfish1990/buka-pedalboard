import '../utils/webaudio-controls.js'
      ...
      // check if the shadowroot host has a background image
        ...
        this._root.getElementById('/smoothDelay/Dry/Wet').value = this._plug.audioNode.getParamValue('/smoothDelay/Dry/Wet');
        ...
        this._root.getElementById('/smoothDelay/Super Wet').value = this._plug.audioNode.getParamValue('/smoothDelay/Super Wet');
...
this._root.getElementById("/smoothDelay/Dry/Wet").addEventListener("input", (e) =>this._plug.audioNode.setParamValue("/smoothDelay/Dry/Wet", e.target.value));
...
this._root.getElementById("/smoothDelay/Super Wet").addEventListener("input", (e) =>this._plug.audioNode.setParamValue("/smoothDelay/Super Wet", e.target.value));
