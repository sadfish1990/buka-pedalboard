import '../../utils/webaudio-controls.js'
      ...
      // check if the shadowroot host has a background image
        ...
        this._root.getElementById('/DualPitchShifter/ShiftL').value = this._plug.audioNode.getParamValue('/DualPitchShifter/ShiftL');
        

        this._root.getElementById('/DualPitchShifter/ShiftR').value = this._plug.audioNode.getParamValue('/DualPitchShifter/ShiftR');
        

        this._root.getElementById('/DualPitchShifter/WindowSize').value = this._plug.audioNode.getParamValue('/DualPitchShifter/WindowSize');
...
this._root.getElementById("/DualPitchShifter/ShiftL").addEventListener("input", (e) =>this._plug.audioNode.setParamValue("/DualPitchShifter/ShiftL", e.target.value));
this._root.getElementById("/DualPitchShifter/ShiftR").addEventListener("input", (e) =>this._plug.audioNode.setParamValue("/DualPitchShifter/ShiftR", e.target.value));
this._root.getElementById("/DualPitchShifter/WindowSize").addEventListener("input", (e) =>this._plug.audioNode.setParamValue("/DualPitchShifter/WindowSize", e.target.value));
