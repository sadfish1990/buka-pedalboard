...
window.requestAnimationFrame(this.handleAnimationFrame);
        ...
        return ['state'];
              ...
              setKnobs() {
                 this._root.getElementById("/OscTube/Fuzz").addEventListener("input", (e) =>this._plug.audioNode.setParamValue("/OscTube/Fuzz", e.target.value));
this._root.getElementById("/OscTube/Resonance").addEventListener("input", (e) =>this._plug.audioNode.setParamValue("/OscTube/Resonance", e.target.value));
this._root.getElementById("/OscTube/Vibrato").addEventListener("input", (e) =>this._plug.audioNode.setParamValue("/OscTube/Vibrato", e.target.value));
              ...
              setSwitches() {
                 this._root.getElementById("/OscTube/bypass").addEventListener("change", (e) =>this._plug.audioNode.setParamValue("/OscTube/bypass", 1 - e.target.value));
      ...
      try {
          customElements.define('wap-osctube', 
                                OscTubeGui);
