...
window.requestAnimationFrame(this.handleAnimationFrame);
        ...
        return ['state'];
              ...
              setKnobs() {
                 this._root.getElementById("/OwlDirty/DECAY").addEventListener("input", (e) =>this._plug.audioNode.setParamValue("/OwlDirty/DECAY", e.target.value));
this._root.getElementById("/OwlDirty/DRIVE").addEventListener("input", (e) =>this._plug.audioNode.setParamValue("/OwlDirty/DRIVE", e.target.value));
this._root.getElementById("/OwlDirty/MIX").addEventListener("input", (e) =>this._plug.audioNode.setParamValue("/OwlDirty/MIX", e.target.value));
this._root.getElementById("/OwlDirty/TONE").addEventListener("input", (e) =>this._plug.audioNode.setParamValue("/OwlDirty/TONE", e.target.value));
              ...
              setSwitches() {
                 this._root.getElementById("/OwlDirty/bypass").addEventListener("change", (e) =>this._plug.audioNode.setParamValue("/OwlDirty/bypass", 1 - e.target.value));
      ...
      try {
          customElements.define('wap-owldirty', 
                                OwlDirtyGui);
