...
import GoldenHorseNode from "./Node.js";
...
export default class GoldenHorsePlugin extends WebAudioModule {
    ...
    async createAudioNode(initialState) {
        const node = new GoldenHorseNode(this.audioContext, { baseURL: this._baseURL });
        ...
        const paramMgr = await ParamMgrFactory.create(this, {
            internalParamsConfig: {
                ...
                output: { defaultValue: 0.5, minValue: 0, maxValue: 1 }
            }
        });
