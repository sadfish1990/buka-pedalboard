...
import SuperLeadNode from "./Node.js";
...
export default class SuperLeadPlugin extends WebAudioModule {
    ...
    async createAudioNode(initialState) {
        const node = new SuperLeadNode(this.audioContext, { baseURL: this._baseURL });
