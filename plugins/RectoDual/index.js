...
import RectoDualNode from "./Node.js";
...
export default class RectoDualPlugin extends WebAudioModule {
    ...
    async createAudioNode(initialState) {
        const node = new RectoDualNode(this.audioContext, { baseURL: this._baseURL });
        ...
        const paramMgr = await ParamMgrFactory.create(this, {
            internalParamsConfig: {
                ...
                mode: { defaultValue: 1, minValue: 0, maxValue: 1 } // 0=Vintage, 1=Modern
            }
        });
