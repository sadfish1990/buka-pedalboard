...
import Brit30Node from "./Node.js";
...
export default class Brit30Plugin extends WebAudioModule {
    ...
    async createAudioNode(initialState) {
        const node = new Brit30Node(this.audioContext, { baseURL: this._baseURL });
        ...
        const paramMgr = await ParamMgrFactory.create(this, {
            internalParamsConfig: {
                ...
                cut: { defaultValue: 0.0, minValue: 0, maxValue: 1 }, // 0=Open
