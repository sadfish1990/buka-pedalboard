...
</webaudio-knob></div><label for="SHIMMER" style="text-align: center; display: block; touch-action: none; position: static; z-index: 1; color: rgb(255, 255, 255); -webkit-text-stroke: 1px rgb(0, 0, 0); font-family: Skranji; font-size: 20px; border: medium none; place-self: center;" class="drag" font="Skranji" data-x="-35.078216552734375" data-y="-31.28912353515625" contenteditable="false">SHIMMER</label><label for="TONE" style="text-align: center; display: block; touch-action: none; position: static; z-index: 1; color: rgb(255, 255, 255); -webkit-text-stroke: 1px rgb(0, 0, 0); font-family: Skranji; font-size: 20px; border: medium none; place-self: center;" class="drag" font="Skranji" data-x="62.447845458984375" data-y="-111.2843017578125" contenteditable="false">TONE</label></div><label for="untitled" style="display: block; touch-action: none; position: static; z-index: 1; border: medium none; color: rgb(255, 255, 255); -webkit-text-stroke: 1px rgb(0, 0, 0); font-family: Skranji; font-size: 23px; place-self: center;" class="drag" font="Skranji" contenteditable="false">OwlShimmer</label><div class="drag target-style" style="padding: 1px; margin: 1px; text-align: center; display: inline-block; box-sizing: border-box; touch-action: none; position: static; place-self: center;" data-x="42.9976806640625" data-y="-114.33160400390625"><webaudio-switch id="/untitled/bypass" src="/./img/switches/switch_1.png" sprites="100" width="64" height="40" style="touch-action: none;"><style>
...
window.requestAnimationFrame(this.handleAnimationFrame);
        ...
        return ['state'];
              ...
              setKnobs() {
                 this._root.getElementById("/untitled/DECAY").addEventListener("input", (e) =>this._plug.audioNode.setParamValue("/untitled/DECAY", e.target.value));
this._root.getElementById("/untitled/MIX").addEventListener("input", (e) =>this._plug.audioNode.setParamValue("/untitled/MIX", e.target.value));
this._root.getElementById("/untitled/SHIMMER").addEventListener("input", (e) =>this._plug.audioNode.setParamValue("/untitled/SHIMMER", e.target.value));
this._root.getElementById("/untitled/TONE").addEventListener("input", (e) =>this._plug.audioNode.setParamValue("/untitled/TONE", e.target.value));
              ...
              setSwitches() {
                 this._root.getElementById("/untitled/bypass").addEventListener("change", (e) =>this._plug.audioNode.setParamValue("/untitled/bypass", 1 - e.target.value));
      ...
      try {
          customElements.define('wap-owlshimmer', 
                                OwlShimmer);
